...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" href="#scorepesa">Reports</a></li>
</ul>
...
<div class="tab-content">
    <div id="scorepesa" class="tab-pane fade in active">
        ...
        $engine->access_mode = "Virtuals Online Reporting Tool";             // Allows access to a project and all reports in that project
        $engine->initial_execute_mode = "MENU";            // Starts user in Project Menu mode
        $engine->initial_project = "Virtuals Online Reporting Tool";            // Name of report project folder
        ...
        $engine->dynamic_grids_paging = false;
        $engine->dynamic_grids_page_size = 10;
