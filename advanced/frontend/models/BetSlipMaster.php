 ...
 * 
 */
class BetSlipMaster extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['odd_value'], 'number'],
            [['created', 'modified', 'halftime_score', 'fulltime_score',
    ...
    public function voidMatch($parent_match_ids, $sub_type_id = null) {
...
//$_match_ids = join(',', $match_ids);
        ...
        $bet_slips = $this->fetch_bet_slips($match_ids, $sub_type_id);

//prcess bet slips
        $result = $this->process_bet_slip($bet_slips, $parent_match_ids, $sub_type_id);
        return $result;
    }

    protected function process_bet_slip($bet_slips, $parent_match_ids, $sub_type_id) {
...
//insert into void_bet_slip 
                ...
                $vbsql = "INSERT INTO void_bet_slip VALUES(0,$parent_match_id,$bet_id,"
                        ...
                        . "$odd_value,$win,'$created','$modified',$status,$_sub_type_id)";
            ...
            foreach ($parent_match_ids as $key => $parent_match_id) {
                ...
                $bsql = 'UPDATE bet b '
                        ...
                        . 'WHERE s.parent_match_id = ' . $parent_match_id . ' AND  s.sub_type_id <> -1' . $ex_sql;
...
//create outcome and push to queue, sub_type_id=-1,pick=-1
    ...
    protected function fetch_bet_slips($parent_match_id, $sub_type_id) {
        if (empty($sub_type_id)):
